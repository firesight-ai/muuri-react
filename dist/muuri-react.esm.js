...
function useReference(dependencyList) {
  const ref = useRef2(dependencyList);
...
function ItemComponent({
  ...
  return /* @__PURE__ */ React.createElement(ItemProvider, { value: store }, child);
}
ItemComponent.propTypes = {
  ...
  grid: import_prop_types.default.instanceOf(Muuri2).isRequired
};
...
function GridComponent({
  ...
  return /* @__PURE__ */ React2.createElement(GridProvider, { value }, /* @__PURE__ */ React2.createElement(
    "div",
    __spreadValues(__spreadProps(__spreadValues({}, gridProps), {
      ref: store.gridRef
    }), store.fiberController.getFlagProp()),
    store.childrenController.render((child, key) => /* @__PURE__ */ React2.createElement(
      ItemComponent,
      {
        key,
        itemKey: key,
...
import React3, { forwardRef, useEffect as useEffect6 } from "react";
import Muuri5 from "muuri";
...
import Muuri3 from "muuri";
function getInstance(options) {
  const el = document.createElement("div");
  el.style.display = "none";
  document.body.appendChild(el);
  const grid = new Muuri3(el, options);
...
function getDefaultStartPredicate(dragStartPredicate) {
  return typeof dragStartPredicate === "function" ? dragStartPredicate : (item, event) => {
    return Muuri4.ItemDrag.defaultStartPredicate(
      item,
      event,
      dragStartPredicate
    );
...
MuuriComponent.defaultProps = __spreadProps(__spreadValues({}, Muuri5.defaultOptions), {
  dragEnabled: null
});
...
import { useEffect as useEffect9, useCallback } from "react";
...
function withHooks(Component, enabledHooks) {
  ...
  return function WrappedItem(props) {
    return /* @__PURE__ */ React4.createElement(Component, __spreadValues(__spreadValues({}, props), getMerged(hooksHandlers)));
  };
}

// src/index.ts
var AutoScroller = Muuri6.AutoScroller;
var ItemDrag = Muuri6.ItemDrag;
export {
  AutoScroller,
  ChildrenController,
  EventController,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=muuri-react.esm.js.map
